      ...
      (
        ...
        WHERE
          ...
          AND "from" NOT IN (
            ...
            --New rewarder mainnet
            '\x639D20F70bcc01A25355720EF6590Beab6e4a0E7',
            --Merkletree
            '\x6610c566B01ad2076CFdFf3cf68515aaE76a9035',
            --Old rewarder mainnet
            '\x7b4396aac0FF6A948546F4A5200aB9592B28251C',
            --Polygon DAO Main Msig
            '\xAbae9C064bf1fd92Fcfc7052D23De7029C6bbD95',
            --Polygon Bounties Msig
            '\x150fb0cfa5bf3d4023ba198c725b6dcbc1577f21',
            --rewarder polygon
            '\x277A2C1F890D527434cA5eA1286019e083c5A8ee',
            --Cometh rewarder
            '\x8E4b31931aE58Fc0479BeE2FF5Cf9961832045eC',
            --Cometh staking contract
...
FROM
  price p
  LEFT JOIN circ_supply s ON s.datex = p.datex
ORDER BY
  1 DESC