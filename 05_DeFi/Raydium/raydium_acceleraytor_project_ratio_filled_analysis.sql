/* Description: Extract launch dates and max USDC allotted for each accelerator project */
...
SELECT 
    date_trunc('DAY', FROM_UNIXTIME(start_time, 'yyyy-MM-dd HH:mm')) AS launch_date,
    token_name,
    ratio_filled,
    raised_amount_usdc / max_win_lotteries AS max_usdc_allotted
FROM 
    accelerator_shini;