/*
Description: Calculate the number of holders of a specific ERC20 token over time.
*/
...
WITH 
    balances AS (
        ...
        WHERE 
            evt_block_time >= CAST('2021-09-01' AS timestamp)
